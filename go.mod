...
require (
	...
	github.com/oapi-codegen/oapi-codegen/v2 v2.8.1-0.20260828072548-2679cec6ca18 // indirect
	...
	github.com/sqlc-dev/sqlc v1.31.2-0.20260910172007-4b222605712d // indirect
