...
func Test_buildRPHTTPClient_withDiscoveryConfig(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, "https://example.com/token", nil)
...
func Test_cachedDiscoveryTransport_wellKnownURL(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(t.Context(), http.MethodGet, wellKnownURL, nil)
