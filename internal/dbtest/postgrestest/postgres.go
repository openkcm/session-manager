...
func createTestConfig() func() {
	...
	// We have to adjust this as soon as the clientID is being removed
	// from the configuration. For the moment it is no longer used in the
	// application code, but is still required in the config
