...
func (tc transportCredentials) ResourceServer(ctx context.Context, clientID, issuer string) (rs.ResourceServer, error) {
	return rs.NewResourceServerClientCredentials(ctx, issuer, clientID, "", rs.WithClient(tc.client()))
}
